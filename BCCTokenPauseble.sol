...
contract PIAICBCCToken is IERC20{
     ...
     */
    function transfer(address recipient, uint256 amount) public virtual isActive override returns (bool) {
     ...
     */
    function allowance(address tokenOwner, address spender) public view virtual isActive override returns (uint256) {
     ...
     */
    function approve(address spender, uint256 amount) public virtual override isActive returns (bool) {
     ...
     * `amount`.
     */
    function transferFrom(address tokenOwner, address recipient, uint256 amount) public isActive virtual override returns (bool) {
    ...
    function pausedToken() public onlyOwner isActive returns(bool){
        tokenPaused = true;
        return true;
    }
}